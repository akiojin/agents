...
import { DEFAULT_AGENTS_MODEL, DEFAULT_AGENTS_FLASH_MODEL } from './models.js';
...
describe('Flash Model Fallback Configuration', () => {
  ...
  describe('setModel', () => {
    it('should update the model and mark as switched during session', () => {
      expect(config.getModel()).toBe(DEFAULT_AGENTS_MODEL);
      expect(config.isModelSwitchedDuringSession()).toBe(false);

      config.setModel(DEFAULT_AGENTS_FLASH_MODEL);

      expect(config.getModel()).toBe(DEFAULT_AGENTS_FLASH_MODEL);
    ...
    it('should only mark as switched if contentGeneratorConfig exists', () => {
      ...
      newConfig.setModel(DEFAULT_AGENTS_FLASH_MODEL);
